...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        [ChildActionOnly]
        public ActionResult NhaXeLink()
        {
            var customer = _workContext.CurrentCustomer;

            var model = new NhaXeLinkModel()
            {
                ImpersonatedCustomerEmailUsername = customer.IsRegistered() ? (_customerSettings.UsernamesEnabled ? customer.Username : customer.Email) : "",
                IsCustomerImpersonated = _workContext.OriginalCustomerIfImpersonated != null,
                DisplayNhaXeLink = _permissionService.Authorize(StandardPermissionProvider.CVQLNhaXe),
            };
        ...
        [ChildActionOnly]
        public ActionResult HuongDan4B()
        {
            return PartialView();
        }
        #endregion
