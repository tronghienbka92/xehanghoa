...
{
    [Validator(typeof(TaiKhoanValidator))]
    public class TaiKhoanModel : BaseNopEntityModel
    {
        public TaiKhoanModel()
        {
            this.AvailableCustomerRoles = new List<TaiKhoanRoleModel>();
            NhanVienId = 0;
        }
        ...
        public List<TaiKhoanRoleModel> AvailableCustomerRoles { get; set; }
        public int[] SelectedCustomerRoleIds { get; set; }

        public List<VanPhongModel> AvailableNhanVienVanPhongs { get; set; }

        public int[] SelectedNhanVienVanPhongIds { get; set; }
