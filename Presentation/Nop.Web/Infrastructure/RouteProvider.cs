...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //routes.MapLocalizedRoute("timkiem",
            //               "",
            //               new { controller = "Home", action = "timkiem" },
            //               new[] { "Nop.Web.Controllers" });
            //nha xe 
            routes.MapLocalizedRoute("NhaXeManager",
                            "NhaXes/",
                            new { controller = "NhaXes", action = "Index" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("QLPhoiVe",
                            "QLPhoiVe/",
                            new { controller = "QLPhoiVe", action = "Index" },
                            new[] { "Nop.Web.Controllers" });
            //nha xe 
            routes.MapLocalizedRoute("VeXeKhach",
                            "",
                            new { controller = "VeXeKhach", action = "Index" },            
                            new[] { "Nop.Web.Controllers" });
            //TuyenVeXe
            /*
            routes.MapLocalizedRoute("TuyenVeXe",
                            "",
                            new { controller = "VeXeKhach", action = "TuyenVeXeKhach" },
                            new[] { "Nop.Web.Controllers" });
             */ 
            //widgets
            ...
            routes.MapLocalizedRoute("Register",
                            "register/",
                            new { controller = "Customer", action = "DangKy" },
                            new[] { "Nop.Web.Controllers" });
            //logout
