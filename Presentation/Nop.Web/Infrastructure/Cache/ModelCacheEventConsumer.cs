...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        public const string NEWSITEM_PICTURE_MODEL_KEY = "Nop.pres.news.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string NEWSITEM_PICTURE_PATTERN_KEY = "Nop.pres.news.picture";
        /// <summary>
