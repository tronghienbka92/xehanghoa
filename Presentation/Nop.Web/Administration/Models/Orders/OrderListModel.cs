...
namespace Nop.Admin.Models.Orders
{
    public partial class OrderListModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Orders.List.CountOrderPending")]
        public int CountOrderPending { get; set; }
        [NopResourceDisplayName("Admin.Orders.List.CountOrderProcessing")]
        public int CountOrderProcessing { get; set; }
        [NopResourceDisplayName("Admin.Orders.List.CountOrderComplete")]
