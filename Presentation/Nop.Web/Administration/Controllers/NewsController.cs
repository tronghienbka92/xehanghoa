...
namespace Nop.Admin.Controllers
{
    public partial class NewsController : BaseAdminController
	{
        ...
        [NonAction]
        protected virtual void UpdatePictureSeoNames(NewsItem news)
        {
            var picture = _pictureService.GetPictureById(news.PictureId);
            if (picture != null)
                _pictureService.SetSeoFilename(picture.Id, _pictureService.GetPictureSeName(news.Title));
        }
