...
namespace Nop.Admin.Infrastructure
{
    public class AutoMapperStartupTask : IStartupTask
    {
        public void Execute()
        {
            ...
            ///add by lent
            Mapper.CreateMap<HopDongModel, HopDong>()
                .ForMember(dest => dest.TrangThai, mo => mo.Ignore())
                .ForMember(dest => dest.NguoiTaoID, mo => mo.Ignore())
                .ForMember(dest => dest.NguoiDuyetID, mo => mo.Ignore())
                .ForMember(dest => dest.MaHopDong, mo => mo.Ignore())
                .ForMember(dest => dest.NgayTao, mo => mo.Ignore())
                .ForMember(dest => dest.NgayCapNhat, mo => mo.Ignore())
                .ForMember(dest => dest.NgayHetHan, mo => mo.Ignore())
                .ForMember(dest => dest.NgayKichHoat, mo => mo.Ignore())
                .ForMember(dest => dest.TrangThaiID, mo => mo.Ignore())
                .ForMember(dest => dest.KhachHang, mo => mo.Ignore())
                .ForMember(dest => dest.LoaiHopDong, mo => mo.Ignore());
            Mapper.CreateMap<HopDong, HopDongModel>()
                .ForMember(dest => dest.TrangThaiText, mo => mo.Ignore())
                .ForMember(dest => dest.ListLoaiHopDong, mo => mo.Ignore())
                .ForMember(dest => dest.KhachHang, mo => mo.Ignore())
                .ForMember(dest => dest.ListNhaXe, mo => mo.Ignore());


            Mapper.CreateMap<NhaXeModel, NhaXe>()
                .ForMember(dest => dest.DiaChiID, mo => mo.Ignore())
                .ForMember(dest => dest.MaNhaXe, mo => mo.Ignore())
                .ForMember(dest => dest.NguoiTaoID, mo => mo.Ignore());

            Mapper.CreateMap<NhaXe, NhaXeModel>()
                .ForMember(dest => dest.ThongTinDiaChi, mo => mo.Ignore());


            Mapper.CreateMap<DiaChiModel, DiaChi>()
                .ForMember(dest => dest.Province, mo => mo.Ignore());

            Mapper.CreateMap<DiaChi, DiaChiModel>()
                .ForMember(dest => dest.AvailableStates, mo => mo.Ignore());
