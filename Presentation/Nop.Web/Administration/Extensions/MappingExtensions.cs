...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        #endregion
        #region Chon Ve
        public static HopDongModel ToModel(this HopDong entity)
        {           
            return entity.MapTo<HopDong, HopDongModel>();
        }
        public static AgentsModel ToModel(this Agents entity)
        {
            return entity.MapTo<Agents, AgentsModel>();
        }
        ...
        public static DiaChiModel ToModel(this DiaChi entity)
        {
            return entity.MapTo<DiaChi, DiaChiModel>();
        }
