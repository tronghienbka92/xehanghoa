...
namespace Nop.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private NhaXe _cachedNhaXe;
        private NhanVien _cachedNhanVien;
        private VanPhong _cachedVanPhong;
        private int _nhaxeId = 0;
        ...
        { 
            get
            {
                ...
                {
                    if (_httpContext.Session["NhaXeId"] != null)
                        _nhaxeId = Convert.ToInt32(_httpContext.Session["NhaXeId"]);
                    else
                        _nhaxeId = CurrentNhaXe.Id;
                }
        ...
        public virtual NhaXe CurrentNhaXe
        {
            get
            {
                if (_cachedNhaXe != null)
                    return _cachedNhaXe;
                if (this._nhaxeId == 0)
                {
                    _cachedNhaXe = _nhaxeService.GetNhaXeByCustommerId(CurrentCustomer.Id);
                    this.NhaXeId = _cachedNhaXe.Id;
                }
                else
                {
                    _cachedNhaXe = _nhaxeService.GetNhaXeById(this._nhaxeId);
                }
                return _cachedNhaXe;
            }
        }
        public virtual NhanVien CurrentNhanVien
        {
            get
            {
                if (_cachedNhanVien != null)
                    return _cachedNhanVien;
                _cachedNhanVien = _nhanvienService.GetByCustomerId(CurrentCustomer.Id);
                return _cachedNhanVien;
            }
        }
        public virtual VanPhong CurrentVanPhong
        {
            get
            {
                if (_cachedVanPhong != null)
                    return _cachedVanPhong;
                _cachedVanPhong = _nhaxeService.GetVanPhongById(CurrentNhanVien.VanPhongID.GetValueOrDefault(0));
                return _cachedVanPhong;
            }
        }
        #endregion
