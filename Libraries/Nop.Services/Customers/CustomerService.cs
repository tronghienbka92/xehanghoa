...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        #region Customers
        public virtual IPagedList<Customer> GetAllCustomersByNhaXeID(int NhaXeID = 0,
           int pageIndex = 0, int pageSize = 2147483647)
        {
            var query = _customerRepository.Table
                .Join(_nhanvienRepository.Table,x=>x.Id,y=>y.CustomerID, (x, y) => new { Customer = x, NhanVien = y })
                .Where(c=>!c.Customer.Deleted)
                .Where(c=>c.NhanVien.NhaXeID==NhaXeID)
                .Select(c=>c.Customer);
        ...
        public virtual List<Customer> Search(string email = "")
        {
        ...
        public virtual IList<Customer> GetAllNhanVienVanChuyen()
        {
            var query = _customerRepository.Table;
                ...
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where((z => z.Attribute.KeyGroup == "Customer" &&
                        z.Attribute.Key == SystemCustomerAttributeNames.IsNhanVienVanChuyen &&
                        z.Attribute.Value.Contains("True") ))
                    .Select(z => z.Customer);
