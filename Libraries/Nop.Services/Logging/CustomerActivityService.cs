...
namespace Nop.Services.Logging
{
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        public virtual ActivityLog InsertActivityNhaXe(string comment, params object[] commentParams)
        {
            return InsertActivity("NhaXe.Log", comment, _workContext.CurrentCustomer, commentParams);
        }
