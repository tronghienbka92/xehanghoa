...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        #endregion
        public virtual void ExportBaoCaoKhachHang(Stream stream, List<KhachHangMuaVeItem> Items, DateTime TuNgay, DateTime DenNgay)
        {
            {
                if (stream == null)
                    throw new ArgumentNullException("stream");
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    worksheet.Cells[1, 1].Value = "Thống kê khách hàng";
                    ...
                    foreach (var item in Items)
                    {
                        ...
                        col++;
                        worksheet.Cells[row, col].Value = item.TenKhachHang;
                        col++;

                        worksheet.Cells[row, col].Value = item.SoDienThoai;
                        col++;

                        worksheet.Cells[row, col].Value = item.SoLuot;
                        col++;
                    ...
                    worksheet.Cells[row, coltong].Value = Items.Sum(c => c.SoLuot);
                    coltong++;
                    //style header
        ...
        public virtual void ExportHanhTrinhVeQuay(Stream stream, List<VeItemHanhTrinh> Items, DateTime TuNgay, DateTime DenNgay,string TenHanhTrinh)
        {
            {
                if (stream == null)
                    throw new ArgumentNullException("stream");
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    // get handle to the existing worksheet
                    var worksheet = xlPackage.Workbook.Worksheets.Add("HanhTrinhVeQuay");
                    //Create Headers and format them
                    worksheet.DefaultRowHeight = 20;
                    worksheet.Cells["A1:G1"].Merge = true;
                    
                    worksheet.Cells[1, 1].Value = TenHanhTrinh;
                    worksheet.Cells["B2"].Value = "";
                    ...
                    worksheet.Cells["C4:C5"].Merge = true;
                    worksheet.Cells["C4"].Value = "Quyển";

                    worksheet.Cells["D4:D5"].Merge = true;
                    worksheet.Cells["D4"].Value = "Seri đầu";

                    worksheet.Cells["E4:E5"].Merge = true;
                    worksheet.Cells["E4"].Value = "Seri cuối";

                    worksheet.Cells["F4:F5"].Merge = true;
                    worksheet.Cells["F4"].Value = "Số lượng";

                    worksheet.Cells["G4:G5"].Merge = true;
                    worksheet.Cells["G4"].Value = "Đơn giá";

                    worksheet.Cells["H4:H5"].Merge = true;
                    worksheet.Cells["H4"].Value = "Thành tiền";

                    worksheet.Cells["I4:I5"].Merge = true;
                    worksheet.Cells["I4"].Value = "Tuyến";
                    ...
                    foreach (var item in Items)
                    {
                        ...
                        worksheet.Cells[row, col].Value = item.STT;
                        col++;
                        worksheet.Cells[row, col].Value = item.NgayBan.ToString("dd/MM/yyyy");
                        col++;

                        worksheet.Cells[row, col].Value = item.SoQuyen;
                        col++;

                        worksheet.Cells[row, col].Value = item.SeriDau;
                        col++;

                        worksheet.Cells[row, col].Value = item.SeriCuoi;
                        col++;

                        worksheet.Cells[row, col].Value = item.SoLuong;
                        col++;

                        worksheet.Cells[row, col].Value = item.DonGia.ToString("####,###");
                        col++;

                        worksheet.Cells[row, col].Value = item.ThanhTien.ToString("####,###");
                        col++;

                        worksheet.Cells[row, col].Value = item.Tuyen;
                        col++;
                        row++;
                        STT++;
                    ...
                    worksheet.Cells[row, coltong].Value = Items.Sum(c => c.SoLuong);
                    coltong=coltong + 2;
                    worksheet.Cells[row, coltong].Value = Items.Sum(c => c.ThanhTien).ToString("####,###");
                    //style header
        ...
        public virtual   void ExportHanhTrinhHangHoa(Stream stream, List<ThongKeHangHoa> Items, DateTime TuNgay, DateTime DenNgay, string TenHanhTrinh)
        {
            {
                if (stream == null)
                    throw new ArgumentNullException("stream");
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    // get handle to the existing worksheet
                    var worksheet = xlPackage.Workbook.Worksheets.Add("HanhTrinhHangHoa");
                    //Create Headers and format them
                    worksheet.DefaultRowHeight = 20;
                    worksheet.Cells["A1:G1"].Merge = true;
                    ...
                    worksheet.Cells["B4:B5"].Merge = true;
                    worksheet.Cells["B4"].Value = "Tuyến";

                    worksheet.Cells["C4:C5"].Merge = true;
                    worksheet.Cells["C4"].Value = "Ngày đi";

                    worksheet.Cells["D4:D5"].Merge = true;
                    worksheet.Cells["D4"].Value = "Biển số xe";

                    worksheet.Cells["E4:E5"].Merge = true;
                    worksheet.Cells["E4"].Value = "Mã phiếu";

                    worksheet.Cells["F4:F5"].Merge = true;
                    worksheet.Cells["F4"].Value = "Tên hàng";

                    worksheet.Cells["G4:G5"].Merge = true;
                    worksheet.Cells["G4"].Value = "Số lượng";

                    worksheet.Cells["H4:H5"].Merge = true;
                    worksheet.Cells["H4"].Value = "Đơn giá";

                    worksheet.Cells["I4:I5"].Merge = true;
                    worksheet.Cells["I4"].Value = "Thành tiền";

                    worksheet.Cells["J4:J5"].Merge = true;
                    worksheet.Cells["J4"].Value = "Tên lái xe";

                    worksheet.Cells["K4:K5"].Merge = true;
                    worksheet.Cells["K4"].Value = "Tên phụ xe";
                    ...
                    foreach (var item in Items)
                    {
                        ...
                        worksheet.Cells[row, col].Value = item.MaPhieuGui;
                        col++;

                        worksheet.Cells[row, col].Value = item.TenHang;
                        col++;
                        ...
                        worksheet.Cells[row, col].Value = item.TenNTV;
                        col++;
                        row++;
                        STT++;
                    ...
                    //style body
                    var modelRows = row;
                    string modelRange = "A6:K" + modelRows.ToString();
                    var modelTable = worksheet.Cells[modelRange];
        ...
        public virtual void ExportBaoCaoLaiXePhuXe(Stream stream, List<BaoCaoLaiXePhuXe> Items, DateTime TuNgay, DateTime DenNgay)
        {
            {
                if (stream == null)
                    throw new ArgumentNullException("stream");
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    worksheet.Cells[1, 1].Value = "Doanh thu lái phụ xe";
                    worksheet.Cells["B2"].Value = "";
                    ...
                    worksheet.Cells["B4:B5"].Merge = true;
                    worksheet.Cells["B4"].Value = "Tên lái(phụ) xe";

                    worksheet.Cells["C4:C5"].Merge = true;
                    worksheet.Cells["C4"].Value = "CMT";

                    worksheet.Cells["D4:D5"].Merge = true;
                    worksheet.Cells["D4"].Value = "Điện thoại";

                    worksheet.Cells["E4:E5"].Merge = true;
                    worksheet.Cells["E4"].Value = "Chức danh";

                    worksheet.Cells["F4:F5"].Merge = true;
                    worksheet.Cells["F4"].Value = "Tổng lượt";

                    worksheet.Cells["G4:G5"].Merge = true;
                    worksheet.Cells["G4"].Value = "Doanh thu";

                    worksheet.Cells["H4:H5"].Merge = true;
                    worksheet.Cells["H4"].Value = "Tiền lương dự kiến";
                    ...
                    foreach (var item in Items)
                    {
                        ...
                        worksheet.Cells[row, col].Value = stt;
                        col++;
                        worksheet.Cells[row, col].Value = item.HoVaTen;
                        col++;

                        worksheet.Cells[row, col].Value = item.CMT_Id;
                        col++;

                        worksheet.Cells[row, col].Value = item.DienThoai;
                        col++;

                        worksheet.Cells[row, col].Value = item.KieuNhanVienText;
                        col++;

                        worksheet.Cells[row, col].Value = item.TongChuyenDi;
                        col++;

                        worksheet.Cells[row, col].Value = item.TongDoanhThu;
                        col++;

                        worksheet.Cells[row, col].Value = item.TongLuong;
                        col++;
                    ...
                    worksheet.Cells[row, coltong].Value = Items.Sum(c => c.TongChuyenDi);
                    coltong++;

                    worksheet.Cells[row, coltong].Value = Items.Sum(c => c.TongDoanhThu).ToString("###,###");
                    coltong++;
                    worksheet.Cells[row, coltong].Value = Items.Sum(c => c.TongLuong).ToString("###,###");
                    coltong++;
        ...
        public virtual void ExportBaoCaoDoanhThu(Stream stream, HanhTrinhDateItem[,] DoanhThuLuot, int Thang, int Nam, int SoHanhTrinh, int SoNhan)
        {
            {
                if (stream == null)
                    throw new ArgumentNullException("stream");
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    worksheet.Cells[1, 2].Value = "Doanh thu tuyến";
                    worksheet.Cells["B2"].Value = "";
                    ...
                    worksheet.Cells["E2"].Value = "Tháng " + Thang + " Năm " + Nam;
                    worksheet.Cells["E2"].Style.Font.Bold = true;

                    int row = 6;
                    int c = 1;
                    for (int i = 0; i < SoHanhTrinh + 1; i++)
                    {
                        int col = 1;
                       
                        for (int j = 0; j < SoNhan + 2; j++)
                        {
                            if (i == 0 && j > 0 && j < SoNhan + 1)
                            {

                                worksheet.Cells[i + 6, col].Value = DoanhThuLuot[0, j].Nhan.ToString();
                            }
                            if (j == 0 && i > 0)
                            {
                                worksheet.Cells["A" + row + ":A" + (row + 3)].Merge = true;
                                worksheet.Cells["A" + row + ":A" + (row + 3)].Style.VerticalAlignment = ExcelVerticalAlignment.Center;                               
                                worksheet.Cells["A" + row + ":A" + (row + 3)].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                                worksheet.Cells["A" + row + ":A" + (row + 3)].Style.Fill.PatternType = ExcelFillStyle.Solid;
                               
                                if (c % 2 == 0)
                                    worksheet.Cells["A" + row + ":A" + (row + 3)].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(130, 130, 130));
                                else
                                    worksheet.Cells["A" + row + ":A" + (row + 3)].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));
                                worksheet.Cells[row, col].Value = DoanhThuLuot[i, j].TenHanhTrinh;
                              //worksheet.Cells["A" + row + ":A" + (row + 3)]
                                worksheet.Cells[row, col + 1].Value = "Số chuyến";
                                worksheet.Cells[row, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));

                                worksheet.Cells[row + 1, col + 1].Value = "Số khách";
                                worksheet.Cells[row + 1, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row+1, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));

                                worksheet.Cells[row + 2, col + 1].Value = "Số khách TB";
                                worksheet.Cells[row + 2, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row+2, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));

                                worksheet.Cells[row + 3, col + 1].Value = "Doanh thu";
                                worksheet.Cells[row + 3, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 3, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(99 ,184 ,255));
                                c++;
                            }
                            if (i > 0 && j > 0 && j < SoNhan + 1)
                            {
                                ...
                                worksheet.Cells[row, col].Value = DoanhThuLuot[i, j].SoChuyen.ToString();
                                worksheet.Cells[row, col].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row , col].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));

                                worksheet.Cells[row + 1, col].Value = DoanhThuLuot[i, j].SoKhach.ToString();
                                worksheet.Cells[row + 1, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 1, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));
                                ...
                                worksheet.Cells[row + 3, col].Value = DoanhThuLuot[i, j].DoanhThu.ToString("###,###");
                               
                            }
                            if (j == SoNhan + 1)
                            {
                                worksheet.Cells[i + 6, col].Value = "";
                    ...
                    //style header
                    string modelRangeheader = "A6:AG6";
                    var modelTableheader = worksheet.Cells[modelRangeheader];
                    modelTableheader.Style.Border.Top.Style = ExcelBorderStyle.Thin;
                    modelTableheader.Style.Border.Left.Style = ExcelBorderStyle.Thin;
                    modelTableheader.Style.Border.Right.Style = ExcelBorderStyle.Thin;
                    ...
                    //style body
                    var modelRows = row;
                    string modelRange = "A7:AG" + modelRows.ToString();
                    var modelTable = worksheet.Cells[modelRange];
        ...
        #region Export bao cao nha xe
        /// <summary>
        /// Ham xuat ra bao cao file execl
        /// </summary>
        /// <param name="stream"></param>
        /// <param name="data">Bang du lieu: xem chu thich o duoi </param>
        /// <param name="Title">Nhan de </param>
        /// <param name="topHeader">Dia chi</param>
        /// <param name="addSumRight">Them cot sum ben phai</param>
        /// <param name="idxColForSum">Tinh tong tu cot tren bang du lieu</param>
        /// <param name="addSumBottom">Them hang sum duoi cung</param>
        public void ExportDataTableToExcel(Stream stream, string[] headers, DataTable data, String[] Title, List<String[]> TitleColSpan, string topPage, bool isShowSTT = true, bool addSumRight = true, int idxColForSum = 1, bool addSumBottom = true)
        {
            if (stream == null)
                throw new ArgumentNullException("stream");
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                // get handle to the existing worksheet
                var worksheet = xlPackage.Workbook.Worksheets.Add("baocao");
                worksheet.DefaultRowHeight = 20;

                int row = 2; //bat dau tu row thu 2
                //tao thong tin dia chi
                //topHeader[0]=CN công ty TNHH Du lịch dịch vụ xây dựng Bảo Yến tại tỉnh Tuyên Quang
                //topHeader[1]=Số 95, Đường Chiến Thắng Sông Lô, P. Tân Quang, TP. Tuyên Quang
                var arrTop = topPage.Split('\n');
                foreach (var _topitem in arrTop)
                {
                    worksheet.Cells[row, 1].Style.Font.Size = 12;
                    worksheet.Cells[row, 1].Style.Font.Bold = true;
                    worksheet.Cells[row, 1].Value = _topitem.Replace("\r", "").Trim();
                    row++;
                }

                //tao thong tin header
                //dua vao so luong cot de tao hang merger cho title
                ...
                foreach (var _title in Title)
                {
                    //merge cell de set gia tri header
                    worksheet.Cells[row, 1, row, numCol].Merge = true;
                    worksheet.Cells[row, 1].Style.Font.Size = 14;
                    worksheet.Cells[row, 1].Style.Font.Bold = true;
                    worksheet.Cells[row, 1].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                    worksheet.Cells[row, 1].Value = _title;
                    row++;
                }

                //bat dau to bang du lieu
                //tao ten cac cot span neu co
                if (TitleColSpan != null && TitleColSpan.Count > 0)
                {
                    int col = 1;
                    if (isShowSTT)
                        col++;

                    //moi phan tu trong TitleColSpan co 2 thong tin: 1: Title ; 2: số cột cần span

                    foreach (var _titlespan in TitleColSpan)
                    {
                        //_titlespan ={ "[Nhan de]","[colspan=3]","[Sum]" } 
                        int colspan = Convert.ToInt32(_titlespan[1]);

                        worksheet.Cells[row, col, row, col + colspan - 1].Merge = true;
                        worksheet.Cells[row, col].Value = _titlespan[0];
                ...
                //tao ten cac cot 
                var arrColTitle = new List<String>();
                if (isShowSTT)
                    arrColTitle.Add("STT");
                foreach (var _header in headers)
                {
                    arrColTitle.Add(_header);
                }
                if (addSumRight)
                    arrColTitle.Add("Tổng");

                int startrow = row;
                for (int i = 0; i < arrColTitle.Count; i++)
                {
                    worksheet.Cells[row, i + 1].Value = arrColTitle[i];
                    worksheet.Cells[row, i + 1].Style.Border.Top.Style = ExcelBorderStyle.Thin;
                    worksheet.Cells[row, i + 1].Style.Border.Left.Style = ExcelBorderStyle.Thin;
                    worksheet.Cells[row, i + 1].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                    worksheet.Cells[row, i + 1].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                ...
                //bat dau dien gia tri vao
                row++;
                int _startRowBody = row;
                decimal _sumallright = decimal.Zero;
                int STT = 1;
                for (int i = 0; i < data.Rows.Count; i++)
                {
                    decimal _sumright = decimal.Zero;
                    int col = 1;
                    if (isShowSTT)
                    {
                        worksheet.Cells[row, col].Value = STT;
                    ...
                    {
                        if (addSumRight && j >= idxColForSum)
                        {
                            decimal _retsum;
                            if (decimal.TryParse(data.Rows[i][j].ToString().Replace(",", "").Replace(".", ""), out _retsum))
                                _sumright = _sumright + _retsum;
                        }
                        worksheet.Cells[row, col].Value = data.Rows[i][j].ToString().Replace(".","");
                                      
                        col++;
                    }
                    if (addSumRight)
                    {
                        worksheet.Cells[row, col].Value = _sumright.ToString();
                        worksheet.Cells[row, col].Style.Font.Bold = true;
                        col++;
                    }
                ...
                if (addSumBottom)
                {
                    ...
                    col = col + idxColForSum;
                    for (int j = idxColForSum; j < data.Columns.Count; j++)
                    {
                        ...
                        worksheet.Cells[row, col].Value = _sumbottom.ToString();
                        worksheet.Cells[row, col].Style.Font.Bold = true;
                        col++;
                    }
                    if (addSumRight)
                    {
                        worksheet.Cells[row, col].Value = _sumallright.ToString();
                        worksheet.Cells[row, col].Style.Font.Bold = true;
                    }
                    ...
                    if (TitleColSpan != null && TitleColSpan.Count > 0)
                    {
                        ...
                        //moi phan tu trong TitleColSpan co 2 thong tin: 1: Title ; 2: số cột cần span; 3: tong gia tri
                        ...
                        foreach (var _titlespan in TitleColSpan)
                        {
                            ...
                            worksheet.Cells[row, col, row, col + colspan - 1].Merge = true;
                            worksheet.Cells[row, col].Value = _titlespan[2];
                            worksheet.Cells[row, col].Style.Border.Top.Style = ExcelBorderStyle.Thin;
                            worksheet.Cells[row, col].Style.Border.Left.Style = ExcelBorderStyle.Thin;
                            worksheet.Cells[row, col].Style.Border.Right.Style = ExcelBorderStyle.Thin;
                            worksheet.Cells[row, col].Style.Border.Bottom.Style = ExcelBorderStyle.Thin;
                ...
                //format cell with thin line                                
                var modelTable = worksheet.Cells[_startRowBody, 1, row, arrColTitle.Count];
                ...
                // Fill worksheet with data to export
                var _modelTable = worksheet.Cells[startrow, 1, row, arrColTitle.Count];
