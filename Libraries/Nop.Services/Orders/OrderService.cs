...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        public virtual  IList<Order> GetOrderByOrderStatus(OrderStatus Status)
        {


            var query = _orderRepository.Table.Where(c => c.OrderStatus == Status).ToList();
        ...
        public virtual int GetcountOrder(int orderstatusid)
        {
            var query =_orderRepository.Table.Where(c=>c.OrderStatusId==orderstatusid).ToList().Count();
            return query;
        }
