...
namespace Nop.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        /// <summary>
        /// Id customer khach vang lai, su dung trong viec ban ve nhanh
        /// </summary>
      
        public static int KhachVangLaiId
        {
            get
            {
                return 2248;
        ...
        /// <summary>
        /// id van phong phu thai
        /// </summary>
        public static int PhuThaiId
        {
            get
            {
                return 100;
        ...
        /// <summary>
        /// id van phong hai duong
        /// </summary>
        public static int HaiDuongId
        {
            get
            {
                return 99;
        ...
        /// <summary>
        /// id van phong pho noi
        /// </summary>
        public static int PhoNoiId
        {
            get
            {
                return 101;
        ...
        /// <summary>
        /// Merchant Id , Su dung trong thanh toan ngan luong
        /// </summary>
        ...
        /// <summary>
        /// Merchant password , Su dung trong thanh toán ngan luong
        /// </summary>
        public static string Merchant_Password
        {
            get
            {
                return "4f6930d2c17ebfe5f32551253b99fb50";
            }
        }
        /// <summary>
        /// Time limit ,Thoi gian het han thanh toan
        /// </summary>
        ...
        /// <summary>
        /// Return_Url, ket qua tra ve khi thanh toan thanh cong
        /// </summary>
        public static string Return_Url
        {
            get
            {
                return "http://localhost:15229/VeXeKhach/ThanhToanThanhCong";
            }
        }
        /// <summary>
        /// Return_Url, ket qua tra ve khi huy thanh toan
        /// </summary>
        public static string Cancel_Url
        {
            get
            {
                return "http://localhost:15229/VeXeKhach/VeXeThanhToan";
            }
        }
        public static ENKhungGio KhungGioHienTai()
        {
            int _hours = DateTime.Now.Hour;
            if (_hours < 12)
                return ENKhungGio.Sang;
            if (_hours < 18)
                return ENKhungGio.Chieu;

            return ENKhungGio.Toi;
        }
